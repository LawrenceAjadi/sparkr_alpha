...
var loadReplySection = function(id) {
    ...
    //Example of prespark 
    $('#stats').append('<div class="col-md-12 minispark"><div class="col-md-12"><p class="text-center msparktitle" style="border-bottom-style: solid; border-bottom-color: #FF5; border-bottom-width: 6px; padding-bottom: 10px">Which has a larger effect on our judgement of stand-up comedy, our taste or the comedians talent?</p></div><div class="col-md-12 subminispark"><div class="col-md-6 pull-left"><button class="btn btn-sprk btn-sprk-left marg-auto">Taste</button></div><div class="col-md-6 pull-right"><button class="btn btn-sprk btn-sprk-right marg-auto">Talent</button></div></div></div><div class="col-md-12"><br></br></div>');
